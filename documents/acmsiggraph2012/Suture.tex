...
Suturing is one of the most common tasks in surgery. (dÈtailler). -Quand on l?apprend (early stage of the surgery eduction) - 
Comment ne pas ´raterª une suture ?
...
%% commentaire: là, il faudrait peut-être un peu moins rentrer dans les détails en citant d'autres papiers: la résolution du contact par contrainte de complémentarité a déjà été traité à de nombreuses reprises (Baraff, ...)
