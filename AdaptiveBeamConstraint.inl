...
{	// We search for the closest segment, on which to project each point
    ...
    helper::ReadAccessor<Data<VecCoord> > x1 = this->mstate1->read(sofa::core::ConstVecCoordId::position()) ;
    helper::ReadAccessor<Data<VecCoord> > x2 = this->mstate2->read(sofa::core::ConstVecCoordId::position()) ;
