...
from beamadapter.sensors import CollisionMonitor, drawCollisionMonitor
...
def createScene(rootNode):
    ...
    rootNode.createObject('CollisionPipeline', draw=False, depth=6, verbose=False)
    ...
    CollisionMonitor(rootNode, instrumentsCombined.DOFs, 60, 6)
    drawCollisionMonitor(rootNode, vessels.meshLoader, vessels.DOFs1, len(vessels.meshLoader.position), 3)
